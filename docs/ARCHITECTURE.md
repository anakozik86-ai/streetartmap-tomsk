...
| 7   | Категории — 8 фиксированных: mural, graffiti, stencil, paste-up, sticker, sculpture, mosaic, other. Иконка = категория                                    |
...
| 10  | Авторы — справочник `authors.json` (slug-id), не свободная строка                                                                                         |
